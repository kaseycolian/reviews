...
public class ReviewRepository {
	...
	public ReviewRepository() {
		...
		Review aphexTwin = new Review(1991L, "Aphex Twin", "./images/aphexTwin.jpg", "Experimental, Ambient Techno, IDM",
